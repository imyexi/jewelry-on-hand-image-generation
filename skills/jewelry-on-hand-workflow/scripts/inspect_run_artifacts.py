...
def _validate_product_structure(
    ...
    if product_type in NECKLACE_PRODUCT_TYPES and (
        length_category is not None
        and length_category not in NECKLACE_LENGTH_CATEGORIES
    ):
        errors.append(
            error_builder(
...
def _validate_modern_decision(
    ...
    if product_type in NECKLACE_PRODUCT_TYPES and snapshot is None:
